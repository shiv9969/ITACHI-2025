...
✯ ʙᴏᴛ sᴇʀᴠᴇʀ: #ᴀɴʏᴡʜᴇʀᴇ
✯ ʙᴏᴛ sᴛᴀᴛᴜs: #ᴏғғʟɪɴᴇ
✯ ʙᴏᴛ ᴏᴡɴᴇʀ: <a href='t.me/bob_files1'>shivv</a>
✯ ʙᴏᴛ sᴜᴘᴘᴏʀᴛ: #ᴜɴᴀᴠᴀɪʟᴀʙʟᴇ
✯ ʙᴏᴛ ᴅᴀᴛᴀʙᴀsᴇ: <a href='https://www.mongodb.com'>ᴍᴏɢᴏᴅʙ</a></b>"""
    ...
    FUTURE = "<b>ᴏʀ ᴋɪʏᴀ ғᴇᴀᴛᴜʀᴇs ᴄʜᴀɪʏᴇ ʙʀᴏᴏ ? 😶\n\nʀᴇᴇʟ ᴅᴏᴡɴʟᴏᴅ, ʏᴛ ᴅᴏᴡɴʟᴏᴀᴅ, sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ, ʀᴇᴘᴏ ᴅᴏᴡɴʟᴏᴀᴅ, sᴛʏʟɪsʜ ғᴏɴᴛ, ᴄʜᴀᴛ ɢᴘᴛ, ʟᴏᴅᴀ, ʟᴀssᴀɴ ᴇᴛᴄ...\n\nʏᴇ sᴜʙ ᴄʜɪʏᴇ ᴛᴏ ᴋᴀɪ ᴏʀ ᴄʜᴀʟᴇ ᴊᴀ ʙsᴅᴋ 🤬</b>"

    REQM = """<b>अगर कोई मूवी ना मिले तो.....🤒\nआप Admin को रिर्पोट भेज सकते हो...📚\nइस तरह से रिपोर्ट भेजे....👇\n\n/request Pushpa 2021\n/request Chhichhore 2019\n/request Vikings S01E03\n/request Money Heist S03E05\n\n👉 मूवी का year भी लिखे... 👀\n\n━━━━━━━━━━━━━━━━━━\n\nɪꜰ ᴍᴏᴠɪᴇ ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ʙᴏᴛ...🤒\nᴛʜᴇɴ ꜱᴇɴᴅ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴ...📚\nʜᴏᴡ ᴛᴏ ꜱᴇɴᴅ ʀᴇᴘᴏʀᴛ...👇\n\n/request Pushpa 2021\n/request Chhichhore 2019\n/request Vikings S01E03\n/request Money Heist S03E05\n\n👉 ᴅᴏɴ'ᴛ ꜰᴏʀɢᴇᴛ ʀᴇʟᴇᴀꜱᴇ ʏᴇᴀʀ 👀</b>"""

    REQ_REPLY = """<b>ʏᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ sᴀs ʙᴇᴇɴ sᴜᴄᴄᴇssғᴜʟʟʏ\nsᴇɴᴅᴇᴅ ᴀᴅᴍɪɴ 📩✅\n\nᴘʟᴇᴀsᴇ ᴡᴀɪᴛ ғᴏʀ ʀᴇᴘʟʏ....🌿\n\n[ᴅᴏɴ'ᴛ ʙʟᴏᴄᴋ, ᴜɴᴛɪʟ ɢᴇᴛ ʀᴇᴘʟʏ...]</b>"""

    UPGRD_TXT = """🔖 Free</b>\nAds & no direct links.\n\n<b>🪅 Premium</b>\nDirect files & no creepy ads, faster response time, no waiting time, web download and web streaming (Temporery Not Available). ({})\n\n<b>**Plan Cost - ₹50/Month**"""
  
    
    CNFRM_TEXT = """UPI - https://qr-code-bob-files.vercel.app \nQR - https://qr-code-bob-files.vercel.app \n\n**Price - ₹50/Month**\n\n🔅 To Confirm Payment Process, Please Send Your Transaction Screenshot Or Transaction ID To <a href=https://t.me/ASSALUTER_SHIV>A D M I N</a>\n\n📋 Admin delays may occur, request refund if plan activation fails."""

    # Refferal text
    REFFERAL_TEXT = """
**🔗 Here is your refferal link:\n\n{}\n\n👉🏻 Share this link with your friends, Each time they join, Both of you will get 10 refferal points and after 3 reffers/30 points you will get 1 month premium subscription.**
    """
